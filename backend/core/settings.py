...
SECRET_KEY = 'django-insecure-zv(imxx^o6051#otn#7y4p&&ic95z6ulj9f6-7c^)l#%8q*)ci'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'fieldops_db'),
        'USER': os.environ.get('DB_USER', 'fieldops_user'),
